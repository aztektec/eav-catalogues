...
-- Sun Sep 11 22:57:27 2016
-- Model: New Model    Version: 1.0
-- MySQL Workbench Forward Engineering
-- @author Omar Alvarado at aztektec.com.mx
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `eav_attributes_set` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `eav_entity_attribute_groups` ;
...
-- Table `eav_relations`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `eav_relations` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `eav_relations_types` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `entities_varchar` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `entities_datetime` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `entities_decimal` ;
...
-- Table `entities_int`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `entities_int` ;
...
-- Table `entities_text`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `entities_text` ;
...
-- Table `entities_blob`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `entities_blob` ;
